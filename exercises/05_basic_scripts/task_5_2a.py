...
bin_network = "{:08b}{:08b}{:08b}{:08b}".format(octs[0],octs[1],octs[2],octs[3])
bin_network = bin_network[:mask]+"0"*(32-mask)
network = [
...
print(output_network.format(network[0],network[1],network[2],network[3]))
